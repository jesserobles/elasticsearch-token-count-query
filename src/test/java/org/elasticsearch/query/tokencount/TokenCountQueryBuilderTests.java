...
public class TokenCountQueryBuilderTests extends AbstractQueryTestCase<TokenCountQueryBuilder> {
    ...
    @Override
    protected void doAssertLuceneQuery(TokenCountQueryBuilder queryBuilder, Query query, SearchExecutionContext context) {
    ...
    public void testSerialization() throws IOException {
        ...
        try (org.elasticsearch.common.io.stream.BytesStreamOutput output = new org.elasticsearch.common.io.stream.BytesStreamOutput()) {
